...
import CombinedView from '@/views/CombinedViewComponent.vue';
...
const routes = [
  ...
  {
    path: '/combined-view',
    name: 'CombinedView', // Ruta para ver y editar tareas
    component: CombinedView, // Aquí se carga el componente CombinedView
  },
